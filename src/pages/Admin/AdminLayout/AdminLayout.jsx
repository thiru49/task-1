 ...
 /*  useEffect(() => {
  ...
  return (
    <div className={`h-[100vh] grid ${!menu ? 'grid-cols-12' : 'grid-cols-4'} grid-rows-7 gap-1`}>
      <section className="border-2 border-slate-200 bg-sky-100 rounded-md shadow-md row-span-7 flex flex-col">
        <div className="border-b border-sky-200 p-5 text-2xl font-extrabold text-sky-950 flex items-center justify-between">
